        <div id="colonne1">
            ...
            <nav>
                <ul class="first_ul">
                    <li class="one principal_li logo_candidat logo_users"><a class="white bold" href="">Utilisateur</a></li>
                    <li id="new_users">
                        <span class="fa fa-plus-circle logo_add"></span>
                        <a class="blue" href="creationcandidat.php">Crée un utilisateur</a>
                    </li>
